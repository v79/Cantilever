...
class Router internal constructor() {
    ...
    inline fun <reified I, T : Any> get(
        pattern: String, noinline handlerFunction: HandlerFunction<I, T>): RequestPredicate {
    ...
    inline fun <reified I, T : Any> defaultRequestPredicate(
        ...
        noinline handlerFunction: HandlerFunction<I, T>) = RequestPredicate(
...
/**
 * Entry point for creating an AWS Lambda routing functioni
 */
...
data class RouterFunction<I, T : Any>(
    val requestPredicate: RequestPredicate, val handler: HandlerFunction<I, T>, var requiresPermission: String? = null)
